...
package com.csrgo.problems.basic.PrintEncodings.dsa;

import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

public class PrintEncodingsTest {
    ...
    private static void runTestCase(int testNumber, String str) {
        ...
        List<String> actualResult = PrintEncodings.solve(str);
    ...
    public static void main(String[] args) {
        System.out.println("Running PrintEncodings tests...");
