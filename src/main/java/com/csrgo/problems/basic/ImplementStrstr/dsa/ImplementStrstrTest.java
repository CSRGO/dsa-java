...
package com.csrgo.problems.basic.ImplementStrstr.dsa;
...
public class ImplementStrstrTest {
    ...
    private static void runTestCase(int testNumber, String haystack, String needle) {
        ...
        int actualResult = ImplementStrstr.solve(haystack, needle);
    ...
    public static void main(String[] args) {
        System.out.println("Running ImplementStrstr tests...");
