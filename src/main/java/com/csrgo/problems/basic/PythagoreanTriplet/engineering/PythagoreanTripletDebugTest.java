...
package com.csrgo.problems.basic.PythagoreanTriplet.engineering;

import java.util.*;
import com.csrgo.util.*;

public class PythagoreanTripletDebugTest {
    ...
    public static void main(String[] args) {
        ...
        runner.runTests(
            "Pythagorean Triplet",
            testCases,
            input -> PythagoreanTripletDebug.solve(input[0], input[1], input[2]), 
            false 
        );
    }
}
