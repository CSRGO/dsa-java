...
package com.csrgo.problems.basic.StringWithASCIIDifference.dsa;

import java.util.Objects;

public class StringWithASCIIDifferenceTest {
    ...
    private static void runTestCase(int testNumber, String s) {
        ...
        String actualResult = StringWithASCIIDifference.solve(s);
    ...
    public static void main(String[] args) {
        System.out.println("Running StringWithASCIIDifference tests...");
