...
package com.csrgo.problems.basic.AntiDiagonalLinePattern.dsa;

import java.util.*;
import com.csrgo.util.*;

public class AntiDiagonalLinePatternTest {
    ...
    public static void main(String[] args) {
        ...
        runner.runTests(
            "Anti-Diagonal Line Pattern",
            testCases,
            input -> AntiDiagonalLinePattern.solve(input), 
            true 
        );
    }
}
