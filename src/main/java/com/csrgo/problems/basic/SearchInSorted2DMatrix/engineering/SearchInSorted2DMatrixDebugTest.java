...
public class SearchInSorted2DMatrixDebugTest {
    ...
    private static void runTestCase(int testNumber, int[][] mat, int target) {
        ...
        try {
            actualResult = SearchInSorted2DMatrixDebug.solve(mat, target);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running SearchInSorted2DMatrixDebug tests...");
