...
package com.csrgo.problems.basic.LastIndex.dsa;
...
public class LastIndexTest {
    ...
    private static void runTestCase(int testNumber, int[] arr, int target) {
        ...
        int actualResult = LastIndex.solve(arr, target);
    ...
    public static void main(String[] args) {
        System.out.println("Running LastIndex tests...");
        ...
        runTestCase(10, new int[]{1, 2, 3, 2, 1}, 1);
