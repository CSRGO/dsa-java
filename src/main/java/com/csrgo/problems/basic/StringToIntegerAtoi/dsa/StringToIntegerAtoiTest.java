...
package com.csrgo.problems.basic.StringToIntegerAtoi.dsa;
...
public class StringToIntegerAtoiTest {
    ...
    private static void runTestCase(int testNumber, String s) {
        ...
        int actualResult = StringToIntegerAtoi.solve(s);
    ...
    public static void main(String[] args) {
        System.out.println("Running StringToIntegerAtoi tests...");
