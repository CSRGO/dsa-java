...
public class MazePathsWithJumpsDebugTest {
    ...
    private static void runTestCase(int testNumber, int sr, int sc, int dr, int dc) {
        ...
        try {
            actualResult = MazePathsWithJumpsDebug.solve(sr, sc, dr, dc);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running MazePathsWithJumpsDebug tests...");
