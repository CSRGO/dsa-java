...
public class NQueensDebugTest {
    ...
    private static void runTestCase(int testNumber, int n) {
        ...
        try {
            actualResult = NQueensDebug.solve(n);
        } catch (Exception e) {
        ...
        if (Objects.equals(expectedResult, actualResult)) {
            ...
            System.out.println("Test " + testNumber + " FAILED: n=" + n + ", expected=" + expectedResult.size() + ", actual=" + (actualResult == null ? "null" : actualResult.size()));
            totalFailed++;
        }
    }

    public static void main(String[] args) {
        System.out.println("Running NQueensDebug tests...");
