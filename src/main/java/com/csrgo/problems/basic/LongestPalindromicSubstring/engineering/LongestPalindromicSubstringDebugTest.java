...
public class LongestPalindromicSubstringDebugTest {
    ...
    private static void runTestCase(int testNumber, String s) {
        ...
        try {
            actualResult = LongestPalindromicSubstringDebug.solve(s);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running LongestPalindromicSubstringDebug tests...");
