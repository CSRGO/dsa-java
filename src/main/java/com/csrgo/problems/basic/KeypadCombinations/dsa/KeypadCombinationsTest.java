...
package com.csrgo.problems.basic.KeypadCombinations.dsa;

import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

public class KeypadCombinationsTest {
    ...
    private static void runTestCase(int testNumber, String str) {
        ...
        List<String> actualResult = KeypadCombinations.solve(str);
    ...
    public static void main(String[] args) {
        System.out.println("Running KeypadCombinations tests...");
