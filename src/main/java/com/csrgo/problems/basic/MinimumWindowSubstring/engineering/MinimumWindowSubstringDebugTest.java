...
public class MinimumWindowSubstringDebugTest {
    ...
    private static void runTestCase(int testNumber, String s, String t) {
        ...
        try {
            actualResult = MinimumWindowSubstringDebug.solve(s, t);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running MinimumWindowSubstringDebug tests...");
