...
package com.csrgo.problems.basic.PalindromePartitioning.dsa;
...
public class PalindromePartitioningTest {
    ...
    private static void runTestCase(int testNumber, String s) {
        ...
        List<List<String>> actualResult = normalize(PalindromePartitioning.solve(s));
    ...
    public static void main(String[] args) {
        System.out.println("Running PalindromePartitioning tests...");
