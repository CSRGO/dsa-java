...
package com.csrgo.problems.basic.CombinationSum.dsa;
...
public class CombinationSumTest {
    ...
    private static void runTestCase(int testNumber, int[] candidates, int target) {
        ...
        List<List<Integer>> actualResult = normalize(CombinationSum.solve(candidates, target));
    ...
    public static void main(String[] args) {
        System.out.println("Running CombinationSum tests...");
