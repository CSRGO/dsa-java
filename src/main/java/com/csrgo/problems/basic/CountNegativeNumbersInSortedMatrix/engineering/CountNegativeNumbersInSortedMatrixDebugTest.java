...
public class CountNegativeNumbersInSortedMatrixDebugTest {
    ...
    private static void runTestCase(int testNumber, int[][] grid) {
        ...
        int actualResult = 0;
        try {
            actualResult = CountNegativeNumbersInSortedMatrixDebug.solve(grid);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running CountNegativeNumbersInSortedMatrixDebug tests...");
