...
package com.csrgo.problems.basic.TargetSumSubsets.dsa;

import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

public class TargetSumSubsetsTest {
    ...
    private static void runTestCase(int testNumber, int[] arr, int target) {
        ...
        List<List<Integer>> actualResult = TargetSumSubsets.solve(arr, target);
    ...
    public static void main(String[] args) {
        System.out.println("Running TargetSumSubsets tests...");
