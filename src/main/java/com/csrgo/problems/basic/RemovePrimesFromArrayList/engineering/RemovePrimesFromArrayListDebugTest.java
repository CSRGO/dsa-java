...
public class RemovePrimesFromArrayListDebugTest {
    ...
    private static void runTestCase(int testNumber, ArrayList<Integer> original) {
        ...
        ArrayList<Integer> actualResult = null;
        try {
            actualResult = RemovePrimesFromArrayListDebug.solve(input);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running RemovePrimesFromArrayListDebug tests...");
