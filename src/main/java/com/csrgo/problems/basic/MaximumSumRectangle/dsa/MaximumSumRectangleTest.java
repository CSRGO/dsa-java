...
package com.csrgo.problems.basic.MaximumSumRectangle.dsa;
...
public class MaximumSumRectangleTest {
    ...
    private static void runTestCase(int testNumber, int[][] mat) {
        ...
        int actualResult = MaximumSumRectangle.solve(mat);
    ...
    public static void main(String[] args) {
        System.out.println("Running MaximumSumRectangle tests...");
