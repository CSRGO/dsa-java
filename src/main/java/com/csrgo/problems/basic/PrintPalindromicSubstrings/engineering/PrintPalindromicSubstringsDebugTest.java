...
public class PrintPalindromicSubstringsDebugTest {
    ...
    private static void runTestCase(int testNumber, String s) {
        ...
        try {
            actualResult = PrintPalindromicSubstringsDebug.solve(s);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running PrintPalindromicSubstringsDebug tests...");
