...
public class EquilibriumIndexDebugTest {
    ...
    private static void runTestCase(int testNumber, int[] nums) {
        ...
        int actualResult = EquilibriumIndexDebug.solve(nums != null ? nums.clone() : null);
    ...
    public static void main(String[] args) {
        System.out.println("Running EquilibriumIndexDebug tests...");
