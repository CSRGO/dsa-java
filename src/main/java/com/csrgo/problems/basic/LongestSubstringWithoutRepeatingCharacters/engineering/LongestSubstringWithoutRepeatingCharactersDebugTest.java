...
public class LongestSubstringWithoutRepeatingCharactersDebugTest {
    ...
    private static void runTestCase(int testNumber, String s) {
        ...
        int actualResult = 0;
        try {
            actualResult = LongestSubstringWithoutRepeatingCharactersDebug.solve(s);
        } catch (Exception e) {
    ...
    public static void main(String[] args) {
        System.out.println("Running LongestSubstringWithoutRepeatingCharactersDebug tests...");
