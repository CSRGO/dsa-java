...
package com.csrgo.problems.basic.SymmetricNumberValley.dsa;

import java.util.*;
import com.csrgo.util.*;

public class SymmetricNumberValleyTest {
    ...
    public static void main(String[] args) {
        ...
        runner.runTests(
            "Symmetric Number Valley",
            testCases,
            input -> SymmetricNumberValley.solve(input), 
            true 
        );
    }
}
