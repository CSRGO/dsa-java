...
package com.csrgo.problems.basic.AlphabetWStarPattern.dsa;

import java.util.*;
import com.csrgo.util.*;

public class AlphabetWStarPatternTest {
    ...
    public static void main(String[] args) {
        ...
        List<TestCase<Integer, String>> testCases = List.of(
            ...
            new TestCase<>("Three Rows Compact W", 3, "*\t\t*\n*\t*\t*\n*\t\t*\n"),
            new TestCase<>("Five Rows Standard Example", 5, "*\t\t\t\t*\n*\t\t\t\t*\n*\t\t*\t\t*\n*\t*\t\t*\t*\n*\t\t\t\t*\n"),
            new TestCase<>("Seven Rows Expanded Glyph", 7, buildExpected(7)),
        ...
        runner.runTests(
            "Alphabet W Star Pattern",
            testCases,
            input -> AlphabetWStarPattern.solve(input), 
            true 
        );
    }
}
