...
package com.csrgo.problems.basic.SearchIn2DMatrix.dsa;
...
public class SearchIn2DMatrixTest {
    ...
    private static void runTestCase(int testNumber, int[][] mat, int target) {
        ...
        boolean actualResult = SearchIn2DMatrix.solve(mat, target);
    ...
    public static void main(String[] args) {
        System.out.println("Running SearchIn2DMatrix tests...");
