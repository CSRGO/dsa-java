...
package com.csrgo.problems.basic.ShellRotate.dsa;

import java.util.Arrays;

public class ShellRotateTest {
    ...
    private static void runTestCase(int testNumber, int[][] mat, int s, int r) {
        ...
        int[][] actualResult = ShellRotate.solve(deepClone(mat), s, r);
    ...
    public static void main(String[] args) {
        System.out.println("Running ShellRotate tests...");
