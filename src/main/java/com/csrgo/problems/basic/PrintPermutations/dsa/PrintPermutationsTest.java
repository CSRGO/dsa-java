...
package com.csrgo.problems.basic.PrintPermutations.dsa;

import java.util.ArrayList;
import java.util.List;
import java.util.Objects;

public class PrintPermutationsTest {
    ...
    private static void runTestCase(int testNumber, String str) {
        ...
        List<String> actualResult = PrintPermutations.solve(str);
    ...
    public static void main(String[] args) {
        System.out.println("Running PrintPermutations tests...");
